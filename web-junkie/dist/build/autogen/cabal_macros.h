...
/* package snap-core-0.7.0.1 */
#define VERSION_snap_core "0.7.0.1"
#define MIN_VERSION_snap_core(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  7 || \
  (major1) == 0 && (major2) == 7 && (minor) <= 0)

/* package snap-server-0.7.0.1 */
#define VERSION_snap_server "0.7.0.1"
...
/* package xmlhtml-0.1.6 */
#define VERSION_xmlhtml "0.1.6"
